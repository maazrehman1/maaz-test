              ...
              <form>
                <div className="space-y-4">
                  <div>
                    ...
                    <input ref={emailRef} id="email" className="form-input w-full" type="email" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input ref={passwordRef} id="password" className="form-input w-full" type="password" autoComplete="on" />
                  </div>
                </div>
                <div className="flex items-center justify-between mt-6">
                  ...
                  <Link className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3 whitespace-nowrap" 
                  to=""
                   onClick={handleSignup}  to="/signin"> Sign Up</Link>
                   </button>
                </div>
              </form>
